...
struct PomodoroView: View{
    ...
    func startNewCycle() {
        selectedWorkTime = timerValues?.integer(forKey: "selectedWorkTime") ?? 25
        shortBreakTime = timerValues?.integer(forKey: "shortBreakTime") ?? 5
        longBreakTime = timerValues?.integer(forKey: "longBreakTime") ?? 10
        remainingTime = Double(selectedWorkTime*60)
